...
public class GameSceneUI : ContainerRuntime
{
    ...
    public GameSceneUI()
    {
        ...
        TextureAtlas ui = TextureAtlas.FromFile(content, "ui.xml");

        _scoreText = CreateScoreText();
        AddChild(_scoreText);

        _pausePanel = CreatePausePanel(ui);
        AddChild(_pausePanel.Visual);

        _gameOverPanel = CreateGameOverPanel(ui);
    ...
    private Panel CreatePausePanel(TextureAtlas ui)
    {
        ...
        TextureRegion backgroundRegion = ui.GetRegion("panel-background");
        ...
        _resumeButton = new AnimatedButton(ui);
        ...
        AnimatedButton quitButton = new AnimatedButton(ui);
    ...
    private Panel CreateGameOverPanel(TextureAtlas ui)
    {
        Panel panel = new Panel();
        panel.Anchor(Gum.Wireframe.Anchor.Center);
        panel.WidthUnits = DimensionUnitType.Absolute;
        ...
        _retryButton = new AnimatedButton(ui);
    ...
    private void OnResumeButtonClicked(object sender, EventArgs args)
    {
        ...
        // Same Like: if (ResumeButtonClick != null) ResumeButtonClick(sender, args);
