...
4. `WINEPREFIX=~/.winemonogame wine /tmp/dotnet-sdk-8.0.420-win-x64.exe /quiet /install`
5. `export MGFXC_WINE_PATH="$HOME/.winemonogame"` paste on your shell configuration.
